...
class KBRDModel(BaseModel):
    ...
    def build_model(self, *args, **kwargs):
        ...
        self._build_entity_embedding_layer()
    ...
    def _build_entity_embedding_layer(self):
        ...
        #nn.init.kaiming_normal_(self.entity_embedding.weight)
        self.entity_attn = SelfAttentionBatch(self.kg_emb_dim, self.kg_emb_dim)
    ...
    def encode_user(self, entity_lists, kg_embedding):
        ...
        for entity_list in entity_lists:
            ...
            #user_repr = torch.sum(user_repr, dim=0)
    ...
    def recommend(self, batch, mode):
        ...
        #kg_embedding = self.entity_embedding.weight
    ...
    def freeze_parameters(self):
        freeze_models = [self.kg_encoder, self.kg_attn, self.rec_bias,self.entity_embedding]
