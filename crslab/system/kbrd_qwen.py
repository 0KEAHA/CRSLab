...
class KBRDQwenSystem(BaseSystem):
    ...
    def __init__(self, opt, train_dataloader, valid_dataloader, test_dataloader, vocab, side_data, restore_system=False,
        ...
        """
        super(KBRDQwenSystem, self).__init__(opt, train_dataloader, valid_dataloader, test_dataloader, vocab, side_data,
    ...
    def conv_evaluate(self, prediction, response):
        ...
        for p, r in zip(batch_pred_text, response):
        ...
        if stage == 'rec':
            ...
            if mode != 'test':
                ...
                if mode == 'train':
                    ...
                    self.conv_evaluate(preds, batch['response_str'])
